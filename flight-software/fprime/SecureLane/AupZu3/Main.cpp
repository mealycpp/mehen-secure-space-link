...
#include <AupZu3/Top/AupZu3Topology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    SecureLane::TopologyState inputs;
    ...
    SecureLane::setupTopology(inputs);
    SecureLane::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    SecureLane::teardownTopology(inputs);
